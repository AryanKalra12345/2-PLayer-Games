...
score_labels = {}
for i, (label, color) in enumerate([("WINS", "#27ae60"),
                                     ("TIES",  "#f39c12"),
                                     ("LOSSES","#e74c3c")]):
...
def spin():
    ...
    win_msgs  = ["You Won 🎉 — Computer: Lucky you!",
                 "You Won 🎉 — Computer: How?!",
                 "You Won 🎉"]
    lose_msgs = ["You Lose 😬 — Computer: I am better!",
                 "You Lose 😬 — Computer: Boooo!",
                 "You Lose 😬 — Computer: Too easy!"]
    tie_msgs  = ["Tie! 🤝 — Computer: Bad luck!",
...
Button(root, text="SPIN!", font=("Arial", 14, "bold"),
       ...
       padx=30, pady=8, cursor="hand2", command=spin).pack(pady=5)
